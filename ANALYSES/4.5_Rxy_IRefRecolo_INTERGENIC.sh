...
R --vanilla << EOF
    ...
    #save
    write.table(output, "./6_MinorAllelesCount/stats/EXOME_Meanvalues_Rxy_INTERGENICSNPs_RefugiumvsnonRefugiumnoISLnoGBIR_MajorMinorUNR.txt", quote = F, col.names = T, row.names = F)
    ...
    write.table(output, "./6_MinorAllelesCount/stats/EXOME_Jackknife_Rxy_INTERGENICSNPs_RefugiumvsnonRefugiumnoISLnoGBIR_MajorMinorUNR.txt", quote = F, col.names = T, row.names = F)
    ...
    #save
    write.table(output, "./6_MinorAllelesCount/stats/EXOME_Meanvalues_R2xy_INTERGENICSNPs_RefugiumvsnonRefugiumnoISLnoGBIR_MajorMinorUNR.txt", quote = F, col.names = T, row.names = F)
    ...
    #save the jackife results
    write.table(output, "./6_MinorAllelesCount/stats/EXOME_Jackknife_R2xy_INTERGENICSNPs_RefugiumvsnonRefugiumnoISLnoGBIR_MajorMinorUNR.txt", quote = F, col.names = T, row.names = F)
